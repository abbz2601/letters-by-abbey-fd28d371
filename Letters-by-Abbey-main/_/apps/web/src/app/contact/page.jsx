...
export const meta = () => [
  ...
  { name: "description", content: "Have questions about our handwritten letters? Want a custom letter collection? Get in touch with Abbey to discuss your letter needs and special requests." },
  { name: "keywords", content: "contact Letters by Abbey, custom letter requests, handwritten letter inquiries, Abbey contact, letter questions" },
  { property: "og:title", content: "Contact Us - Letters by Abbey" },
  { property: "og:description", content: "Have questions about our handwritten letters? Get in touch with Abbey to discuss your letter needs." },
  { property: "og:url", content: "https://lettersbyabbey.com/contact" },
  { name: "twitter:title", content: "Contact Us - Letters by Abbey" },
  { name: "twitter:description", content: "Have questions about our handwritten letters? Get in touch with Abbey." }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="mt-8 p-6 bg-white border border-[#F0E6E0]">
                ...
                <button className="font-crimson-text text-[#E8A088] hover:text-[#8B6F47] font-semibold transition-colors">
                  View FAQ →
                </button>
              </div>
            </div>
