...
export default function About() {
  const aboutSchema = {
    ...
    "mainEntity": {
      "@type": "Person",
      "name": "Abbey",
      "description": "Creator of Letters by Abbey, handcrafting meaningful letters with intention",
      "knowsAbout": "Handwritten letters, calligraphy, meaningful communication"
    }
  };
  ...
  return (
    <>
      <SEO
        title="About Abbey - The Story Behind Letters by Abbey"
        description="Discover the heartfelt story behind Letters by Abbey. Learn how personal loss inspired a mission to create meaningful handwritten letters that comfort and heal."
        schema={aboutSchema}
      />
      <SkipLink />
      <div className="min-h-screen bg-background">
        ...
        <main id="main-content" className="py-16 md:py-20">
          <div className="max-w-4xl mx-auto px-4 md:px-8">
            ...
            <article className="space-y-6 font-crimson-text text-lg text-muted-foreground leading-relaxed">
